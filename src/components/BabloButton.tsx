  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="text-center">
        {!isActive && (
          <p className="text-primary font-bold text-lg">🚀 Готово к запуску</p>
        )}
        {isActive && !isComplete && (
          <div className="flex flex-col items-center gap-2">
            <p className="text-primary font-bold">💸 Бабло растёт…</p>
            ...
            {/* Progress bar */}
            <div className="w-48 h-3 bg-muted rounded-full overflow-hidden border border-border">
              <div
        ...
        {isActive && isComplete && (
          <p className="text-accent font-black text-lg">✅ Бабло готово! Забирай!</p>
        )}
      </div>
    </div>
  );
